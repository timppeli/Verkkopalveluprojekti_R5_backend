...
try {
  ...
  // Drop all tables
  $query = $db->prepare("DROP TABLE IF EXISTS tilausrivi; DROP TABLE IF EXISTS tilaus; DROP TABLE IF EXISTS tieteellinen_nimi; DROP TABLE IF EXISTS hoitoohje; DROP TABLE IF EXISTS tuote; DROP TABLE IF EXISTS asiakas; DROP TABLE IF EXISTS tuoteryhma;");
  $query->execute();
  // Create all tables
  $query = $db->prepare("CREATE TABLE tuoteryhma (
